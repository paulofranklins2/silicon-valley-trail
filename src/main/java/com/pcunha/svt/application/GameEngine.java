...
public class GameEngine {
    ...
    // 15 real locations along the San Jose to San Francisco corridor
    private List<Location> buildLocations() {
        return List.of(
                ...
                new Location("Cupertino", 37.3230, -122.0322),
                ...
                new Location("San Mateo", 37.5630, -122.3255),
                new Location("Burlingame", 37.5841, -122.3661),
                new Location("Millbrae", 37.5985, -122.3872),
                new Location("South San Francisco", 37.6547, -122.4077),
                new Location("Daly City", 37.6879, -122.4702),
